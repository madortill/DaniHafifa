<template>
  <div id="explosion-part">
    <div class="space-right">
<p class="headline">איך מפוצצים אסטרואיד?</p>
    <p class="information">
...
תפקידכן הוא לכוון את משגר הפצצות לכיוון האסטרואיד לפי הקורדינאטות שקיבלתם מתחנת השיגור.
    ...
    <img src="/pictures/astroAmongUs.svg" alt="astroAmongUs" class="astroAmongUs" />
    <img src="/pictures/rocket.svg" alt="rocket" class="rocket" />
...
@keyframes spin {
    ...
    .rocket {
        position: absolute;
        left: 22%;
        animation: launching 4s linear forwards;
    }
    @keyframes launching {
      0% {
        left: 22%;
