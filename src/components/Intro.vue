          ...
          <tr>
            ...
            <td>
              <img
                class="color"
                :style="{
                  boxShadow: glowEffects['lightblue']
                    ? '0 0 20px yellow'
                    : 'none',
                }"
          ...
          <tr>
            ...
            <td>
              <img
                class="color"
                :style="{
                  boxShadow: glowEffects['darkgreen']
                    ? '0 0 20px yellow'
                    : 'none',
                }"
...
export default {
  ...
  data() {
    return {
      ...
      glowEffects: {
        // Object to track which colors have glowing effect
        red: false,
        brown: false,
        green: false,
        lightblue: false,
...
.type-writer > p {
  animation: typeWrite 1s var(--delay) steps(44) normal both,
